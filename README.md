...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-xml2r-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14426&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-xml2r-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-xml2r` can be installed with:

```
conda install r-xml2r
```

It is possible to list all of the versions of `r-xml2r` available on your platform with:
